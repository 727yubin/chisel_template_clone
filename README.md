...
```sh
git clone git@github.com:727yubin/chisel_template_clone.git
cd chisel_template_clone
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel_template_clone'
...
```sh
mill chisel_template_clone.test
```
